layui.config({
    ...
    var roleSetting = [
        {id:'1',quota:'团队协同性',result:'153',description:'1',reference:'160-190'},
        {id:'2',quota:'个体融入程度',result:'153',description:'0',reference:'30-290'},
        {id:'3',quota:'数据质量',result:'153',description:'1',reference:''}
    ];
    //表格无数据时的样式
